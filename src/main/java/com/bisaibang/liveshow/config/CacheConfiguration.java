package com.bisaibang.liveshow.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("liveshow");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("liveshow");
        ...
        config.getMapConfigs().put("com.bisaibang.liveshow.domain.*", initializeDomainMapConfig(jHipsterProperties));
